...
s0_put_left_key = <Control><Super>Left
s0_put_right_key = <Control><Super>Right
...
[core]
s0_active_plugins = core;composite;opengl;copytex;compiztoolbox;decor;move;vpswitch;gnomecompat;place;grid;regex;snap;resize;imgpng;mousepoll;unitymtgrabhandles;wall;session;animation;expo;workarounds;fade;ezoom;scale;unityshell;
